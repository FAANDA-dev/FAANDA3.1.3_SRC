 ...
 * ./log/1548108881503
 */
public class FPSDataPoolRELV1 extends Output {
    private static final Logger logger = LoggerFactory.getLogger(FPSDataPoolRELV1.class);
     ...
     */
    public FPSDataPoolRELV1(Config config) {
        super(config);
