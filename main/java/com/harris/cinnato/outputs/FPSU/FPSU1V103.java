...
public class FPSU1V103 {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Write CSV header
            writer.println("Aircraft ID,Time at Position,Departure Airport,Arrival Airport");
                    ...
                    try {
                        ...
                        for (int i = 0; i < nodeCount; i++) {
                            ...
                            if (aircraftIdNode != null && timeAtPositionNode != null && airportNode != null && arrivalPointNode != null) {
                                ...
                                writer.println(aircraftIdData + "," + timeAtPositionData + "," + airportData + "," + arrivalPointData);
                            }
                        }
