...
public class FPSU0104 extends Output {
    private final File outputFile;
    private final Logger logger;

    public FPSU0104(Config config) {
        super(config);
        logger = LoggerFactory.getLogger(FPSU0104.class);
        ...
        for (File file : files) {
            try {
                ...
                for (int i = 0; i < nodeList.getLength(); i++) {
                    ...
                    Element fltdMessage = (Element) nodeList.item(i);
                    String data = "test"; 
                    //extractDataFromFltdMessage(fltdMessage); // Implement this method to extract the required data from fltdMessage
