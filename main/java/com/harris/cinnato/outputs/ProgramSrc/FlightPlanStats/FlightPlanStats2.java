 ...
 */
public class FlightPlanStats2 extends Output {
    private static final Logger logger = LoggerFactory.getLogger("file");
    private final File outputFile;
    private String nbsp;
  
        public FlightPlanStats2(Config config) {
            super(config);
...
*/
                ...
                // Obtain the child nodes
                    ...
                    if (childNode.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        Element latitudeElement = (Element) childNode;

                    //      row = row + " " + latitudeElement.getAttribute("aircraftCatigory");
