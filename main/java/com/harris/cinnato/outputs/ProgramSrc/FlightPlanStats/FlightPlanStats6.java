...
//******************************************************************************************************************************************* 
                  ...
                  //child node start  
                  String expressionchild1 = "//fdm:fltdMessage";
                  NodeList childNodes1 = (NodeList) xPath.compile(expressionchild2).evaluate(eElement, XPathConstants.NODESET);
                ...
                // Obtain the child nodes
                    ...
                    if (childNode2.getNodeType() == Node.ELEMENT_NODE) {
                        // Access the child element here
                        Element trackInformation = (Element) childNode2;
                        row = row + "," + trackInformation.getAttribute("aircraftCategory");
                        row = row + "," + trackInformation.getAttribute("userCategory");
