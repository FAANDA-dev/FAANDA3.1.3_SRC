 ...
 */
public class FPSReadFFileLog7 extends Output {
   ...
   // private static final Logger logger = LoggerFactory.getLogger("stdout");
    ...
    //private final File fileLog;
        ...
        public FPSReadFFileLog7(Config config) {
            super(config);
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                ...
                if (eElement.getAttribute("msgType").equals("trackInformation")) {
                    ...
                    String expressionChild4 = "//nxce:eta";
                    ...
                    for (int l = 0; l < childNodes4.getLength(); l++) {
                        Node nNode2 = childNodes4.item(l);
                        if (nNode2.getNodeType() == Node.ELEMENT_NODE) {
                            Element longitudeZElement = (Element) nNode2;
                            row += "," + longitudeZElement.getAttribute("etaType");
                            row += "," + longitudeZElement.getAttribute("timeValue");
