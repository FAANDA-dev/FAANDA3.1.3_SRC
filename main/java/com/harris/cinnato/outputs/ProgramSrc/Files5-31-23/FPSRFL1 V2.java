 ...
 */
public class FPSRFL1 extends Output {
...
/* 
                    ...
                    String expressionChild1 = ".//nxce:computerId";
                    ...
                    for (int j = 0; j < childNodes1.getLength(); j++) {
                        ...
                        if (nNode1.getNodeType() == Node.ELEMENT_NODE) {
                            Element computerIdElement = (Element) nNode1;
                            row = row + "," + computerIdElement.getElementsByTagName("nxce:gufi").item(0).getTextContent();
                            row = row + "," + computerIdElement.getElementsByTagName("nxce:igtd").item(0).getTextContent();
                            
 
                           // row += "," + qualifiedAircraftIdElement.getAttribute("aircraftCategory");
                            //row += "," + qualifiedAircraftIdElement.getAttribute("userCategory");
                        }
                    }
...
*/
                     ...
                     row += "," + eElement.getAttribute("aircraftCategory");
                     row += "," + eElement.getAttribute("userCategory");
                    ...
                    for (int j = 0; j < childNodes2.getLength(); j++) {
                        ...
                        if (nNode2.getNodeType() == Node.ELEMENT_NODE) {
                            Element qualifiedAircraftIdElement = (Element) nNode2;
                            row += "," + qualifiedAircraftIdElement.getAttribute("aircraftCategory");
                            row += "," + qualifiedAircraftIdElement.getAttribute("userCategory");
                        }
                    }
