 ...
 */
public class FlightPlanStats11 extends Output {
    private static final Logger logger = LoggerFactory.getLogger("file");
    private final File outputFile;
    private String nbsp;
  
        public FlightPlanStats11(Config config) {
            super(config);
            ...
            if (nNode.getNodeType() == Node.ELEMENT_NODE) {
             ...
             if (eElement.getAttribute("msgType").equals("trackInformation")) {
                ...
                // Obtain the child nodes
                  ...
                  //child node start  
                 String expressionchildX = "//fdm:fltdMessage";
                 ...
                 // Obtain the child nodes
                     ...
                     if (childNodeX.getNodeType() == Node.ELEMENT_NODE) {
                         // Access the child element here
                         Element position = (Element) childNodeX;
