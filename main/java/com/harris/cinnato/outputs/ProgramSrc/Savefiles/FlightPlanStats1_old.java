 ...
 */
public class FlightPlanStats1 extends Output {
    private static final Logger logger = LoggerFactory.getLogger("file");
    private final File outputFile;
    private String nbsp;
  
        public FlightPlanStats1(Config config) {
            super(config);
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                ...
                String row="";
                       ...
                       */
                       row = row + "Sec-lat=" + eElement.getAttribute("seconds");
                       
                     

                //child node start  
                String expressionchild = "//nxce:longitudeDMS";
                ...
                // Obtain the child nodes
                    ...
                    if (childNode.getNodeType() == Node.ELEMENT_NODE) {
                        // Access the child element here
                        Element longitudeElement = (Element) childNode;
                        ...
                        */
                        row = row + "Sec-long=" + longitudeElement.getAttribute("seconds");   
