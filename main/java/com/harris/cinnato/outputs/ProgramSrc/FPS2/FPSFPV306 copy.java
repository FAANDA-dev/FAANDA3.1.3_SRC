 ...
 */
public class FPSFPV306 extends Output {
   ...
   // private static final Logger logger = LoggerFactory.getLogger("stdout");
    ...
    //private final File fileLog;
        ...
        public FPSFPV306(Config config) {
            super(config);
...
//***************************************************************************************************************************************
                ...
                String expressionChildX2 = ".//nxce:longitudeDMS";
                NodeList childNodesX2 = (NodeList) xPath.compile(expressionChildX2).evaluate(eElement, XPathConstants.NODESET);

                // Iterate over child nodes
                for (j = 0; j < childNodesX2.getLength(); j++) {
                    Node nNodeX2 = childNodesX2.item(j);
                    if (nNode2.getNodeType() == Node.ELEMENT_NODE) {
                        Element longitudeElement = (Element) nNodeX2;
...
FIX = eElement.getAttribute("acid");
