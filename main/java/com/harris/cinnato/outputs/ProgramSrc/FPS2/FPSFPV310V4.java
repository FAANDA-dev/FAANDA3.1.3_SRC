                ...
                if (descendantNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    for (int m = 0; m < furtherDescendants.getLength(); m++) {
                        ...
                        if (furtherDescendantNode.getNodeType() == Node.ELEMENT_NODE) {
                            ...
                            row += "," + furtherDescendantElement.getAttribute("degrees");
                            row += "," + furtherDescendantElement.getAttribute("direction");
                        }
                    }
                    ...
                    for (int m = 0; m < furtherDescendants1.getLength(); m++) {
                        ...
                        if (furtherDescendantNode1.getNodeType() == Node.ELEMENT_NODE) {
                            ...
                            row += "," + furtherDescendantElement1.getAttribute("degrees");
                            row += "," + furtherDescendantElement1.getAttribute("direction");
                        }
                    }
                }
            }
...
// Further processing or usage of 'row' variable can be added here
