                ...
                if (eElement.getAttribute("msgType").equals("trackInformation")) {
                  ...
                  //  if(row == "PHM1*")
                   ...
                   // Process child node 'qualifiedAircraftId'
                    ...
                    PHM = eElement.getAttribute("acid");
                    System.out.println(PHM);
                    String checkacid = PHM.substring(0, 3);
                    System.out.println(checkacid);
                    boolean isEqual = checkacid.equals("PHM");
                    if(isEqual)
                    {
                    ...
                    if(PHM != "")//if PHM1 is True then exec code 
                    {
