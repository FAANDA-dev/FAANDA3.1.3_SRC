 ...
 */
public class FPSFPV304 extends Output {
   ...
   // private static final Logger logger = LoggerFactory.getLogger("stdout");
    ...
    //private final File fileLog;
        ...
        public FPSFPV304(Config config) {
            super(config);
...
System.exit(0);
                   ...
                   // Process child node 'qualifiedAircraftId'
                    ...
                    // Process child node 'qualifiedAircraftId'
                    String expressionChild7 = ".//nxce:qualifiedAircraftId";
                    ...
                    for (int j = 0; j < childNodes7.getLength(); j++) {
                        ...
                        if (nNode7.getNodeType() == Node.ELEMENT_NODE) {
                            Element track = (Element) nNode7;                                   
                            PHM = row + "," + track.getElementsByTagName("nxce:qualifiedAircraftId").item(0).getTextContent();
                    ...
                    if(!PHM.isEmpty())//if PHM1 is True then exec code 
                    {
