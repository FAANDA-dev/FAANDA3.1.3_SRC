 ...
 */
public class FPSN2 extends Output {
    ...
    boolean FIX = false;
        ...
        public FPSN2(Config config) {
            super(config);
                 
                   
            
            outputFile = new File("./log/FlightPlansData8.csv");
             // create the CSV file
             try {
   ...
   private Document loadXMLFromFile() throws Exception {
    ...
    return builder.parse(new File("./log/filex.log"));
}
