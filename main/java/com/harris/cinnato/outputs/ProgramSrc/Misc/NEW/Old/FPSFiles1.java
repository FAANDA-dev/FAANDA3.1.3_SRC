...
public class FPSFiles1 extends Output {
    ...
    public FPSFiles1(Config config) {
        super(config);
        // TODO: change the directory from config
        fileY1 = new File("./log/fileY1.xml");
        fileY2 = new File("./log/fileY2.xml");
        currentFile = fileY1;
    ...
    private void scheduleFileSwitching() {
        ...
        }, 5000); // Switch files after 15 seconds
    }
}
