...
public class FPStatsU12X extends Output {
    private final File outputFile;
    private final Logger logger;

    public FPStatsU12X(Config config) {
        super(config);
        logger = LoggerFactory.getLogger(FPStatsU12X.class);
    ...
    private Document loadXMLFromFile(File file) throws ParserConfigurationException, IOException, SAXException {
